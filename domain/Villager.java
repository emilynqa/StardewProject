...
public class Villager {
	...
	public Villager(Long id, String name, int birthDay, String birthMonth, String faveItem, String leastFaveItem) {
		super();
		this.id = id;
		this.name = name;
	...
	public Villager(String name, int birthDay, String birthMonth, String faveItem, String leastFaveItem) {
		super();
		this.name = name;
		this.birthDay = birthDay;
		this.birthMonth = birthMonth;
	...
	public String toString() {
		return "Villager [id=" + id + ", name=" + name + ", birthDay=" + birthDay + ", birthMonth=" + birthMonth
